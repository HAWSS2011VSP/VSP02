...
public class VSP02GUIAboutBox extends javax.swing.JDialog {

    public VSP02GUIAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(vsp02gui.VSP02GUIApp.class).getContext().getResourceMap(VSP02GUIAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(vsp02gui.VSP02GUIApp.class).getContext().getActionMap(VSP02GUIAboutBox.class, this);
